...
// Operações necessárias e resposta a partir da linha abaixo
export const resposta06 = numeros[0]*numeros[numeros.lenght-2]
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let x = numeros[numeros.length - 1]
numeros[6] = numeros[5]
numeros[5] = numeros[4]
numeros[4] = numeros[3]
numeros[3] = numeros[2]
...
*/
// Nova lista abaixo
const lista = [numeros[numeros.lenght-1], numeros[numeros.lenght-2], numeros[numeros.lenght-3]]
// Operações necessárias e resposta a partir da linha abaixo
