...
*/
// Operações necessárias e resposta a partir da linha abaixo
const tititi = [ frutas[2] , frutas[5] ] = [ frutas[5] , frutas[2] ]

export const resposta05 = tititi
...
let conta = numeros[0] * numeros[numeros.length - 2]
export const resposta06 = conta
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const temp = [ numeros[0] , numeros[1] , numeros[2] , numeros[3] , numeros[4] , numeros[5] , numeros[6] ] = [ numeros[6] , numeros[0] , numeros[1] , numeros[2] , numeros[3] , numeros[4] , numeros[5] ]
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const soma = numeros[0] + numeros[1] + numeros[2] + numeros[3] + numeros[4] + numeros[5] + numeros[6]
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const mudanca = [ numeros[1] , numeros[3] , numeros[5] ] = [numeros[4] , numeros[6] , numeros[1] ]
export const resposta09 = mudanca 
