...
export const resposta01 = profissoes.push("programador(a)", "designer",
...
*/
// Operações necessárias e resposta a partir da linha abaixo
animais.pop ([invertebrados])
animais.push ([vertebrados])
...
pedras.reverse()
pedras.push("calcario", "marmore" , "mica")
pedras.reverse() 
...
pedras.unshift("zirconio")
pedras = pedras.concat([topazio, laruza , onix])
