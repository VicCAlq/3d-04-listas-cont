...
// Operações necessárias e resposta a partir da linha abaixo
const balao = [x, y]
export const resposta05 = profissoes.concat(balao)
...
animais = animais.concat(s1);
animais.reverse();
let s2 = ["lesma", "borboleta", "ostra"];
animais = animais.concat(s2);
...
// Operações necessárias e resposta a partir da linha abaixo
let pedras = [];
let c1 = ["quartzo", "basalto", "granito"];
pedras = pedras.concat(c1);
pedras.reverse();
...
let h1 = ["topázio", "lazurita", "ônix"];
pedras = pedras.concat(h1)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let lista2 = [pedras.pop(), 
        pedras.pop(), 
        pedras.pop(), 
        pedras.pop(), 
        pedras.pop(), 
        pedras.pop()]
export const resposta14 = lista
