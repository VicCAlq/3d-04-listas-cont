...
export const resposta01 = ["programador(a)","designer", "engenheiro(a)", "veterinário(a)","administrador(a)"]
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const administrador = profissoes.pop
export const resposta02 = administrador = "administrador(a)"
...
*/
// Operações necessárias e resposta a partir da linha abaixo
profissoes.unshift("Musico(a)")
export const resposta03 = ["Musico(a)","programador(a)","designer", "engenheiro(a)", "veterinário(a)","administrador(a)"]
...
// Operações necessárias e resposta a partir da linha abaixo
profissoes.shift
const programador = profissoes.shift
export const resposta04 = programador = "programador(a)"
...
*/
// Operações necessárias e resposta a partir da linha abaixo
profissoes =["programador(a)","designer", "engenheiro(a)", "veterinário(a)","administrador(a)"]
profissoes.reverse
export const resposta06 = ["administrador(a)","veterinário(a)","engenheiro(a)","designer","programador(a)"]
...
export const resposta09 = ["elefantes","leopardo","porco-espinho","polvo","formiga","caranguejo"]
